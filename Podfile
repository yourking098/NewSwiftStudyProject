...
pod 'MJRefresh'#【5、MJRefresh库的使用详解】
#pod 'JRefresh' #OC MJRefresh

pod 'ReachabilitySwift'#用来检查应用当前的网络连接状况。

pod 'SwipeCellKit'#【单元格滑动按钮库SwipeCellKit使用详解】
pod 'Charts'#【第三方图表库Charts使用详解】
pod 'CryptoSwift'#【 第三方加密库CryptoSwift使用详解】
pod 'MBProgressHUD'#【第三方透明指示器MBProgressHUD使用详解】
pod 'PromiseKit'#【异步编程库PromiseKit使用详解】
pod 'SideMenu'#【第三方侧栏菜单组件SideMenu使用详解】

pod 'FMDB'#【第三方SQLite库FMDB使用详解】
#pod 'AAInfographics'#【第三方图表库AAInfographics使用详解】
